...
describe "Mixcloud::Cloudcast" do
  ...
  before do
    cloudcast_data = {"sections"=>[{"track"=>{"name"=>"Magic Hour", 
    ...
    JSON.stub(:parse).and_return(cloudcast_data)
  end
  ...
  it "should not have an instance variable named @user" do
  ...
  it "should return the associated user" do
    cloudcast.user.name.should eq 'ctafong'
  end
end